...
package com.android.messaging.md3.ui.conversation;
...
import com.android.messaging.md3.datamodel.MessagingContentProvider;
import com.android.messaging.md3.datamodel.action.InsertNewMessageAction;
import com.android.messaging.md3.datamodel.binding.Binding;
import com.android.messaging.md3.datamodel.binding.BindingBase;
import com.android.messaging.md3.datamodel.binding.ImmutableBindingRef;
import com.android.messaging.md3.datamodel.data.ConversationData;
import com.android.messaging.md3.datamodel.data.ConversationData.ConversationDataListener;
import com.android.messaging.md3.datamodel.data.ConversationMessageData;
import com.android.messaging.md3.datamodel.data.ConversationParticipantsData;
import com.android.messaging.md3.datamodel.data.DraftMessageData;
import com.android.messaging.md3.datamodel.data.DraftMessageData.DraftMessageDataListener;
import com.android.messaging.md3.datamodel.data.MessageData;
...
import com.android.messaging.md3.datamodel.data.SubscriptionListData.SubscriptionListEntry;
import com.android.messaging.md3.ui.AttachmentPreview;
import com.android.messaging.md3.ui.BugleActionBarActivity;
import com.android.messaging.md3.ui.SnackBar;
import com.android.messaging.md3.ui.UIIntents;
import com.android.messaging.md3.ui.animation.PopupTransitionAnimation;
import com.android.messaging.md3.ui.contact.AddContactsConfirmationDialog;
import com.android.messaging.md3.ui.conversation.ComposeMessageView.IComposeMessageViewHost;
import com.android.messaging.md3.ui.conversation.ConversationInputManager.ConversationInputHost;
import com.android.messaging.md3.ui.conversation.ConversationMessageView.ConversationMessageViewHost;
import com.android.messaging.md3.ui.mediapicker.MediaPicker;
import com.android.messaging.md3.util.AccessibilityUtil;
import com.android.messaging.md3.util.Assert;
import com.android.messaging.md3.util.AvatarUriUtil;
import com.android.messaging.md3.util.ChangeDefaultSmsAppHelper;
import com.android.messaging.md3.util.ContentType;
import com.android.messaging.md3.util.ImeUtil;
...
import com.android.messaging.md3.util.SafeAsyncTask;
import com.android.messaging.md3.util.TextUtil;
...
public class ConversationFragment extends Fragment implements ConversationDataListener,
    ...
    private void updateActionAndStatusBarColor(final ActionBar actionBar) {
        final int actionColor = getResources().getColor(R.color.netrual_color_2);
        actionBar.setBackgroundDrawable(new ColorDrawable(actionColor));
        UiUtils.setStatusBarColor(getActivity(), actionColor);
    }
