...
package com.android.messaging.md3.ui.contact;
...
import com.android.messaging.md3.datamodel.action.ActionMonitor;
import com.android.messaging.md3.datamodel.action.GetOrCreateConversationAction;
import com.android.messaging.md3.datamodel.action.GetOrCreateConversationAction.GetOrCreateConversationActionListener;
import com.android.messaging.md3.datamodel.action.GetOrCreateConversationAction.GetOrCreateConversationActionMonitor;
...
import com.android.messaging.md3.ui.CustomHeaderPagerViewHolder;
import com.android.messaging.md3.ui.CustomHeaderViewPager;
import com.android.messaging.md3.ui.animation.ViewGroupItemVerticalExplodeAnimation;
import com.android.messaging.md3.ui.contact.ContactRecipientAutoCompleteView.ContactChipsChangeListener;
import com.android.messaging.md3.util.Assert;
import com.android.messaging.md3.util.Assert.RunsOnMainThread;
import com.android.messaging.md3.util.ContactUtil;
...
public class ContactPickerFragment extends Fragment implements ContactPickerDataListener,
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        mToolbar.setNavigationIcon(R.drawable.ic_twotone_arrow_back_24);
    ...
    private boolean isDarkMode(){
        UiModeManager modeManager = (UiModeManager)getContext().getSystemService(Context.UI_MODE_SERVICE);
    ...
    public void updateActionBar(final ActionBar actionBar) {
        ...
        UiUtils.setStatusBarColor(getActivity(),
                getResources().getColor(R.color.netrual_color_2));
    }
