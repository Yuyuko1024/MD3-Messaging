...
import com.android.messaging.md3.datamodel.MessageNotificationState.BundledMessageNotificationState;
import com.android.messaging.md3.datamodel.MessageNotificationState.ConversationLineInfo;
import com.android.messaging.md3.datamodel.MessageNotificationState.MultiConversationNotificationState;
import com.android.messaging.md3.datamodel.MessageNotificationState.MultiMessageNotificationState;
import com.android.messaging.md3.datamodel.action.MarkAsReadAction;
import com.android.messaging.md3.datamodel.action.MarkAsSeenAction;
import com.android.messaging.md3.datamodel.action.RedownloadMmsAction;
import com.android.messaging.md3.datamodel.media.AvatarRequestDescriptor;
import com.android.messaging.md3.datamodel.media.ImageResource;
import com.android.messaging.md3.datamodel.media.MediaRequest;
import com.android.messaging.md3.datamodel.media.MediaResourceManager;
import com.android.messaging.md3.datamodel.media.MessagePartVideoThumbnailRequestDescriptor;
import com.android.messaging.md3.datamodel.media.UriImageRequestDescriptor;
import com.android.messaging.md3.datamodel.media.VideoThumbnailRequest;
import com.android.messaging.md3.receiver.CaptchaCodeReceiver;
import com.android.messaging.md3.sms.MmsSmsUtils;
...
import com.android.messaging.md3.util.BugleGservices;
import com.android.messaging.md3.util.BugleGservicesKeys;
import com.android.messaging.md3.util.BuglePrefs;
import com.android.messaging.md3.util.BuglePrefsKeys;
import com.android.messaging.md3.util.CaptchaUtil;
import com.android.messaging.md3.util.ContentType;
import com.android.messaging.md3.util.ConversationIdSet;
import com.android.messaging.md3.util.ImageUtils;
import com.android.messaging.md3.util.LogUtil;
import com.android.messaging.md3.util.NotificationPlayer;
import com.android.messaging.md3.util.NotificationsUtil;
import com.android.messaging.md3.util.OsUtil;
import com.android.messaging.md3.util.PendingIntentConstants;
import com.android.messaging.md3.util.ThreadUtil;
...
//            .setPublicVersion(null)    // TODO: when/if we ever support different
    ...
    private static void addCopyCaptchaAction(final NotificationCompat.Builder notifBuilder,
        ...
        PendingIntent captchaIntent = PendingIntent.getBroadcast(context, 0, pendingIntent,PendingIntent.FLAG_IMMUTABLE);
