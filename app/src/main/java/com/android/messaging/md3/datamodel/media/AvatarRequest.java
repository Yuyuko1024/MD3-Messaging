...
public class AvatarRequest extends UriImageRequest<AvatarRequestDescriptor> {
     ...
     * built by {@link com.android.messaging.md3.util.AvatarUriUtil} which will decide on
    ...
    private int getBackgroundColor() {
        final String[] randonAvatarColor = mContext.getResources().getStringArray(
                R.array.random_avatar_color);
        int randomInt = random.nextInt(18);
        //return mContext.getResources().getColor(R.color.primary_color);
        return Color.parseColor(randonAvatarColor[randomInt]);
    }
